...
# fd-future data set
# validating-0 or 1 (0-testing ,1= future prediction)
...
def flood_classifier(filename, fd, validating=0):
    ...
    # Filling null entries with mean of their respective columns
    ...
    # ----------for taking data up to 2018 as training and rest for testing------------
    locate = 0
    for i in range(len(data1["Day"])):
        if data1["Day"][i] == 31 and data1["Months"][i] == 12 and data1["Year"][i] == 2018:
            locate = i
            break
    ...
    # -----------------Up sampling the data (as very less entries of flood =1 is present)-----------------
